...
2. Executar `python3 Skills/site/scripts/site.py <ação> [args]`.
...
```bash
# Listar
python3 Skills/site/scripts/site.py list-links
python3 Skills/site/scripts/site.py list-links --favorites
python3 Skills/site/scripts/site.py list-links --search "openai" --limit 20
python3 Skills/site/scripts/site.py list-links --folder <folder_id>

# Criar
python3 Skills/site/scripts/site.py create-link \
  --title "Anthropic Console" --url "https://console.anthropic.com" \
  --description "Painel da Anthropic" --folder <folder_id> --favorite

# Editar
python3 Skills/site/scripts/site.py update-link <id> --title "Novo" --pinned

# Lixeira
python3 Skills/site/scripts/site.py delete-link <id>
python3 Skills/site/scripts/site.py delete-link <id> --permanent
python3 Skills/site/scripts/site.py restore-link <id>

# Pastas
python3 Skills/site/scripts/site.py list-folders
python3 Skills/site/scripts/site.py create-folder --name "Pesquisa" --color blue
```
