...
CONTACTS_FILE = Path("/workspace/contatos/contatos.json")
LOG_DIR = Path(os.path.expanduser("~/.hermes/skills/whatsapp-api/logs"))
...
def main():
    ...
    # Interpreta \n como quebra de linha (shell passa literal)
